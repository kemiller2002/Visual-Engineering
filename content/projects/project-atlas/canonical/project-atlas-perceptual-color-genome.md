...
1. Luminance carries hierarchy more strongly than hue.
2. Perceptual differences matter more than numerical RGB differences.
3. Saturation increases attention until competing signals create overload.
4. Context changes perceived color more than absolute values.
5. Learned meaning amplifies or suppresses biological salience.
6. Color is most effective when considered alongside typography, spacing, shape, motion, and composition.
