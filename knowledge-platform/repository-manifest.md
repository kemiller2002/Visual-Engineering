...
This repository currently contains a single flat intake corpus with 49 documents and no supporting automation, index, or website code. The corpus is already rich enough to justify a knowledge-platform architecture, but the repository itself is still in an intake state rather than an operational system of record.

## Repository Statistics

- Total files: 49
- Markdown files: 49
- Average word count: 3126.49
- Metadata completeness ratio: 0.59
- Duplicate ratio: 0.08
- Projects detected: 4
- Disciplines detected: 9

### Largest Documents

- intuitive-is-just-familiar-predictive-fit-rep-v2.md (15251 words)
- product-genome-autonomous-research-run-01.md (8865 words)
- component-library-foundations-research-report.md (7882 words)
- intuitive-is-just-familiar-research-report.md (7684 words)
- product-genome-research-execution-package-run-02.md (7354 words)
- project-atlas-typography-autonomous-research-report-v1.md (6755 words)
- 2026-07-21-semantic-durability-research-execution-package.md (6755 words)
- composition-science-visual-density-crowding-and-perceptual-separation.md (6629 words)

### Documents by Project

- Project Atlas: 26
- Composition Science: 18
- Product Genome: 3
- Design Library: 2

## Health Assessment

- Organizational quality: low
- Naming consistency: medium
- Metadata quality: low
- Duplicated knowledge: high
- Missing relationships: high
...
Average catalog confidence score: 0.66
