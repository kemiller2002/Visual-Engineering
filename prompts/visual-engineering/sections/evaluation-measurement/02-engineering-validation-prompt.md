---
id: PRM-VE-EVL-002
title: Evaluation, Measurement, and Experimentation: Engineering Translation and Validation Prompt
...
# Evaluation, Measurement, and Experimentation: Engineering Translation and Validation
...
Read `roadmap.md`, the completed foundation REP and registry updates, `../../../../content/concepts/research-methodology`, `../../../../content/projects/composition-science/experiment-report`, `../../../../content/projects/design-library/experiment-report`, and evaluation/accessibility roadmaps. If no completed foundation REP exists, stop and record the dependency. Separate repository claims, external evidence, and engineering judgment.
...
4. What experiment can distinguish each candidate from Metric choice changes conclusions and encourages proxy optimization and Evidence quality is multidimensional and cannot be collapsed into one grade?
