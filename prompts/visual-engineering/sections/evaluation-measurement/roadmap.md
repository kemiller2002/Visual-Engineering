---
id: RDM-VE-EVL-001
title: Evaluation, Measurement, and Experimentation Research Roadmap
...
# Evaluation, Measurement, and Experimentation Research Roadmap

## A. Identity and scope

- **Identifier:** VE-EVL
- **Area and disciplines:** Evaluation, Measurement, and Experimentation; measurement validity review, protocol design, benchmark construction, preregistered replication
- **Repository paths:** `content/concepts/research-methodology/`, `content/projects/composition-science/experiment-report/`, `content/projects/design-library/experiment-report/`
- **Why it exists:** Create valid measures and research infrastructure linking visual interventions to consequential outcomes.
...
- **Adjacent sections:** perception-attention, spatial-composition, governance-knowledge-system.
- **Taxonomy judgment:** create as foundational shared infrastructure. This boundary follows mechanisms and decisions, not current folders.

## B. Current state

- **Maturity / confidence / priority:** Exploratory / low / P0.
...
- **Hidden assumptions:** Common UX metrics adequately detect visual-engineering effects; Repository evidence grades are comparable across methods and projects.
...
- **Foundational:** Which outcomes distinguish notice, comprehension, decision quality, error, and trust?
- **Explanatory:** What minimal experiment metadata enables replication?
- **Comparative:** How should external validity and heterogeneity affect promotion thresholds?
- **Boundary-condition:** Which outcomes distinguish notice, comprehension, decision quality, error, and trust?
- **Applied engineering:** What minimal experiment metadata enables replication?
- **Measurement:** How should external validity and heterogeneity affect promotion thresholds?
- **Ethical/accessibility:** Which outcomes distinguish notice, comprehension, decision quality, error, and trust?
- **Cross-disciplinary:** What minimal experiment metadata enables replication?

## E. Hypothesis portfolio

### VE-EVL-H1

- **Statement:** Common UX metrics adequately detect visual-engineering effects.
...
- **Contradiction/rivals:** Metric choice changes conclusions and encourages proxy optimization.
...
- **Method:** measurement validity review, protocol design, benchmark construction, preregistered replication.

### VE-EVL-H2

- **Statement:** Repository evidence grades are comparable across methods and projects.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Evidence quality is multidimensional and cannot be collapsed into one grade.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-EVL-H1/H2.
- **Disciplines/sources/method:** measurement validity review, protocol design, benchmark construction, preregistered replication; primary research, reviews, standards, failures, and counterexamples.
- **Artifacts:** REP, evidence/hypothesis updates, contradiction ledger, coverage table.
- **Dependencies:** none; may begin immediately.
...
P0 because the section has few prerequisites and high cross-section reuse, consequential error cost, and falsifiable assumptions. Foundation work precedes translation because available documentation is not equivalent to validated evidence. Accessibility and external-validity audits run in parallel to reduce avoidable rework.
