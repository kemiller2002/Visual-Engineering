---
id: PRM-VE-EVL-001
title: Evaluation, Measurement, and Experimentation: Foundation and Falsification Research Prompt
...
Discover whether the repository's governing claims about evaluation, measurement, and experimentation survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/research-methodology`, `../../../../content/projects/composition-science/experiment-report`, `../../../../content/projects/design-library/experiment-report`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (perception-attention, spatial-composition, governance-knowledge-system). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which outcomes distinguish notice, comprehension, decision quality, error, and trust?
2. What minimal experiment metadata enables replication?
3. How should external validity and heterogeneity affect promotion thresholds?

## Initial and rival hypotheses

- **VE-EVL-H1:** Common UX metrics adequately detect visual-engineering effects. Rival: Metric choice changes conclusions and encourages proxy optimization. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-EVL-H2:** Repository evidence grades are comparable across methods and projects. Rival: Evidence quality is multidimensional and cannot be collapsed into one grade. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
