---
id: RDM-VE-COL-001
title: Color, Contrast, and Appearance Research Roadmap
...
# Color, Contrast, and Appearance Research Roadmap

## A. Identity and scope

- **Identifier:** VE-COL
- **Area and disciplines:** Color, Contrast, and Appearance; measurement review, standards crosswalk, device simulations, discrimination and comprehension experiments
- **Repository paths:** `content/concepts/color/`, `content/projects/project-atlas/`
- **Why it exists:** Model relational color appearance and determine safe engineering uses for differentiation, emphasis, and meaning.
...
- **Adjacent sections:** accessibility-cultural-transfer, evaluation-measurement, spatial-composition.
- **Taxonomy judgment:** retain; split measurement from semantic use. This boundary follows mechanisms and decisions, not current folders.

## B. Current state

- **Maturity / confidence / priority:** Theory-forming / medium / P1.
...
- **Hidden assumptions:** Modern perceptual spaces adequately predict interface color differences; Relational color principles transfer from art pedagogy to digital task performance.
...
- **Foundational:** Which color metrics predict discrimination and meaning under interface conditions?
- **Explanatory:** When do simultaneous contrast and adaptation matter operationally?
- **Comparative:** How should redundant encodings constrain semantic color?
- **Boundary-condition:** Which color metrics predict discrimination and meaning under interface conditions?
- **Applied engineering:** When do simultaneous contrast and adaptation matter operationally?
- **Measurement:** How should redundant encodings constrain semantic color?
- **Ethical/accessibility:** Which color metrics predict discrimination and meaning under interface conditions?
- **Cross-disciplinary:** When do simultaneous contrast and adaptation matter operationally?

## E. Hypothesis portfolio

### VE-COL-H1

- **Statement:** Modern perceptual spaces adequately predict interface color differences.
...
- **Contradiction/rivals:** Context, adaptation, device, gamut, age, and deficiency overwhelm nominal color-space distance.
...
- **Method:** measurement review, standards crosswalk, device simulations, discrimination and comprehension experiments.

### VE-COL-H2

- **Statement:** Relational color principles transfer from art pedagogy to digital task performance.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Historical systems are useful vocabularies but weak causal models.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-COL-H1/H2.
- **Disciplines/sources/method:** measurement review, standards crosswalk, device simulations, discrimination and comprehension experiments; primary research, reviews, standards, failures, and counterexamples.
