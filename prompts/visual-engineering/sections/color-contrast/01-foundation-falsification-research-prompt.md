---
id: PRM-VE-COL-001
title: Color, Contrast, and Appearance: Foundation and Falsification Research Prompt
...
# Color, Contrast, and Appearance: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about color, contrast, and appearance survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/color`, `../../../../content/projects/project-atlas`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (accessibility-cultural-transfer, evaluation-measurement, spatial-composition). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which color metrics predict discrimination and meaning under interface conditions?
2. When do simultaneous contrast and adaptation matter operationally?
3. How should redundant encodings constrain semantic color?

## Initial and rival hypotheses

- **VE-COL-H1:** Modern perceptual spaces adequately predict interface color differences. Rival: Context, adaptation, device, gamut, age, and deficiency overwhelm nominal color-space distance. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-COL-H2:** Relational color principles transfer from art pedagogy to digital task performance. Rival: Historical systems are useful vocabularies but weak causal models. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
