---
id: PRM-VE-COL-002
title: Color, Contrast, and Appearance: Engineering Translation and Validation Prompt
...
# Color, Contrast, and Appearance: Engineering Translation and Validation
...
Read `roadmap.md`, the completed foundation REP and registry updates, `../../../../content/concepts/color`, `../../../../content/projects/project-atlas`, and evaluation/accessibility roadmaps. If no completed foundation REP exists, stop and record the dependency. Separate repository claims, external evidence, and engineering judgment.
...
4. What experiment can distinguish each candidate from Context, adaptation, device, gamut, age, and deficiency overwhelm nominal color-space distance and Historical systems are useful vocabularies but weak causal models?
