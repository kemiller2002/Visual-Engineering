---
id: RDM-VE-CMP-001
title: Components, Tokens, and Declarative Systems Research Roadmap
...
# Components, Tokens, and Declarative Systems Research Roadmap

## A. Identity and scope

- **Identifier:** VE-CMP
- **Area and disciplines:** Components, Tokens, and Declarative Systems; architecture evidence review, mutation testing, cross-project prototypes, accessibility conformance tests
- **Repository paths:** `content/concepts/component-architecture/`, `content/projects/design-library/`
- **Why it exists:** Test whether reusable visual primitives preserve semantics, accessibility, and adaptability across projects.
...
- **Adjacent sections:** governance-knowledge-system, accessibility-cultural-transfer, evaluation-measurement.
- **Taxonomy judgment:** retain; broaden beyond framework choice. This boundary follows mechanisms and decisions, not current folders.
...
- **Hidden assumptions:** Standardized components reduce human and agent error; A shared component core can preserve meaning across contexts.
...
- **Foundational:** Which invariants belong in components, tokens, schemas, or guidance?
- **Explanatory:** How do escape hatches affect consistency and safety?
- **Comparative:** What tests demonstrate semantic durability across renderers?
- **Boundary-condition:** Which invariants belong in components, tokens, schemas, or guidance?
- **Applied engineering:** How do escape hatches affect consistency and safety?
- **Measurement:** What tests demonstrate semantic durability across renderers?
- **Ethical/accessibility:** Which invariants belong in components, tokens, schemas, or guidance?
- **Cross-disciplinary:** How do escape hatches affect consistency and safety?

## E. Hypothesis portfolio

### VE-CMP-H1

- **Statement:** Standardized components reduce human and agent error.
...
- **Contradiction/rivals:** Standardization shifts errors into composition and misuse.
...
- **Method:** architecture evidence review, mutation testing, cross-project prototypes, accessibility conformance tests.

### VE-CMP-H2

- **Statement:** A shared component core can preserve meaning across contexts.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Domain-specific components outperform universal abstractions on safety and clarity.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-CMP-H1/H2.
- **Disciplines/sources/method:** architecture evidence review, mutation testing, cross-project prototypes, accessibility conformance tests; primary research, reviews, standards, failures, and counterexamples.
- **Artifacts:** REP, evidence/hypothesis updates, contradiction ledger, coverage table.
- **Dependencies:** product-semantics.
