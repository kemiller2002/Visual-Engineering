---
id: PRM-VE-CMP-001
title: Components, Tokens, and Declarative Systems: Foundation and Falsification Research Prompt
...
# Components, Tokens, and Declarative Systems: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about components, tokens, and declarative systems survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/component-architecture`, `../../../../content/projects/design-library`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (governance-knowledge-system, accessibility-cultural-transfer, evaluation-measurement). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which invariants belong in components, tokens, schemas, or guidance?
2. How do escape hatches affect consistency and safety?
3. What tests demonstrate semantic durability across renderers?

## Initial and rival hypotheses

- **VE-CMP-H1:** Standardized components reduce human and agent error. Rival: Standardization shifts errors into composition and misuse. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-CMP-H2:** A shared component core can preserve meaning across contexts. Rival: Domain-specific components outperform universal abstractions on safety and clarity. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
