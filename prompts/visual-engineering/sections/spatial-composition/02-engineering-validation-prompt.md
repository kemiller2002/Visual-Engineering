---
id: PRM-VE-SPA-002
title: Spatial Composition, Density, and Hierarchy: Engineering Translation and Validation Prompt
...
# Spatial Composition, Density, and Hierarchy: Engineering Translation and Validation
...
Read `roadmap.md`, the completed foundation REP and registry updates, `../../../../content/concepts/composition`, `../../../../content/concepts/spacing`, `../../../../content/concepts/hierarchy`, `../../../../content/projects/composition-science`, and evaluation/accessibility roadmaps. If no completed foundation REP exists, stop and record the dependency. Separate repository claims, external evidence, and engineering judgment.
...
4. What experiment can distinguish each candidate from Multiple task-relative hierarchies outperform a single visual order and Semantic structure and interaction history explain benefits attributed to geometry?
