---
id: RDM-VE-SPA-001
title: Spatial Composition, Density, and Hierarchy Research Roadmap
...
# Spatial Composition, Density, and Hierarchy Research Roadmap

## A. Identity and scope

- **Identifier:** VE-SPA
- **Area and disciplines:** Spatial Composition, Density, and Hierarchy; mechanism review, corpus measurement, factorial layout experiments, expert–novice comparison
- **Repository paths:** `content/concepts/composition/`, `content/concepts/spacing/`, `content/concepts/hierarchy/`, `content/projects/composition-science/`
- **Why it exists:** Explain how grouping, spacing, proportion, density, and hierarchy form usable visual scenes.
...
- **Adjacent sections:** wayfinding-familiarity, typography-legibility, evaluation-measurement.
- **Taxonomy judgment:** merge composition, spacing, hierarchy, and density. This boundary follows mechanisms and decisions, not current folders.
...
- **Hidden assumptions:** A coherent hierarchy reliably improves comprehension and action; Spacing ratios can be converted into reusable rules independent of content and task.
...
- **Foundational:** What mechanisms connect spatial relations to task outcomes?
- **Explanatory:** When does density aid expert scanning rather than create overload?
- **Comparative:** Which relational measures generalize across viewport and content changes?
- **Boundary-condition:** What mechanisms connect spatial relations to task outcomes?
- **Applied engineering:** When does density aid expert scanning rather than create overload?
- **Measurement:** Which relational measures generalize across viewport and content changes?
- **Ethical/accessibility:** What mechanisms connect spatial relations to task outcomes?
- **Cross-disciplinary:** When does density aid expert scanning rather than create overload?

## E. Hypothesis portfolio

### VE-SPA-H1

- **Statement:** A coherent hierarchy reliably improves comprehension and action.
...
- **Contradiction/rivals:** Multiple task-relative hierarchies outperform a single visual order.
...
- **Method:** mechanism review, corpus measurement, factorial layout experiments, expert–novice comparison.

### VE-SPA-H2

- **Statement:** Spacing ratios can be converted into reusable rules independent of content and task.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Semantic structure and interaction history explain benefits attributed to geometry.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-SPA-H1/H2.
- **Disciplines/sources/method:** mechanism review, corpus measurement, factorial layout experiments, expert–novice comparison; primary research, reviews, standards, failures, and counterexamples.
