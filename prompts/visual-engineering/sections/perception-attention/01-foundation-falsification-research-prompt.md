---
id: PRM-VE-PER-001
title: Perception and Attention: Foundation and Falsification Research Prompt
...
# Perception and Attention: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about perception and attention survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/perception`, `../../../../content/concepts/attention`, `../../../../content/projects/composition-science`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (spatial-composition, evaluation-measurement, accessibility-cultural-transfer). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which perceptual mechanisms predict task success rather than first fixation?
2. Where do crowding, eccentricity, contrast, and expertise change conclusions?
3. Which measurements survive transfer from laboratory stimuli to interfaces?

## Initial and rival hypotheses

- **VE-PER-H1:** Laboratory salience effects predict task-directed attention in production interfaces. Rival: Goals, expectation, and learned task structure dominate bottom-up salience. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-PER-H2:** Perceptual findings transfer across devices, expertise, and impairment. Rival: Effects reverse under time pressure, peripheral viewing, or assistive technology. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
