---
id: RDM-VE-PER-001
title: Perception and Attention Research Roadmap
...
# Perception and Attention Research Roadmap

## A. Identity and scope

- **Identifier:** VE-PER
- **Area and disciplines:** Perception and Attention; systematic review, replication audit, task-based eye-tracking and error experiments
- **Repository paths:** `content/concepts/perception/`, `content/concepts/attention/`, `content/projects/composition-science/`
- **Why it exists:** Explain how visual signals become selectable, discriminable, and stable under realistic viewing conditions.
...
- **Adjacent sections:** spatial-composition, evaluation-measurement, accessibility-cultural-transfer.
- **Taxonomy judgment:** retain and narrow. This boundary follows mechanisms and decisions, not current folders.

## B. Current state

- **Maturity / confidence / priority:** Evidence-building / medium / P0.
...
- **Hidden assumptions:** Laboratory salience effects predict task-directed attention in production interfaces; Perceptual findings transfer across devices, expertise, and impairment.
...
- **Foundational:** Which perceptual mechanisms predict task success rather than first fixation?
- **Explanatory:** Where do crowding, eccentricity, contrast, and expertise change conclusions?
- **Comparative:** Which measurements survive transfer from laboratory stimuli to interfaces?
- **Boundary-condition:** Which perceptual mechanisms predict task success rather than first fixation?
- **Applied engineering:** Where do crowding, eccentricity, contrast, and expertise change conclusions?
- **Measurement:** Which measurements survive transfer from laboratory stimuli to interfaces?
- **Ethical/accessibility:** Which perceptual mechanisms predict task success rather than first fixation?
- **Cross-disciplinary:** Where do crowding, eccentricity, contrast, and expertise change conclusions?

## E. Hypothesis portfolio

### VE-PER-H1

- **Statement:** Laboratory salience effects predict task-directed attention in production interfaces.
...
- **Contradiction/rivals:** Goals, expectation, and learned task structure dominate bottom-up salience.
...
- **Method:** systematic review, replication audit, task-based eye-tracking and error experiments.

### VE-PER-H2

- **Statement:** Perceptual findings transfer across devices, expertise, and impairment.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Effects reverse under time pressure, peripheral viewing, or assistive technology.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-PER-H1/H2.
- **Disciplines/sources/method:** systematic review, replication audit, task-based eye-tracking and error experiments; primary research, reviews, standards, failures, and counterexamples.
