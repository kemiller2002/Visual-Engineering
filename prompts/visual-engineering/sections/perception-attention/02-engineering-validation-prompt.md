---
id: PRM-VE-PER-002
title: Perception and Attention: Engineering Translation and Validation Prompt
...
# Perception and Attention: Engineering Translation and Validation
...
Read `roadmap.md`, the completed foundation REP and registry updates, `../../../../content/concepts/perception`, `../../../../content/concepts/attention`, `../../../../content/projects/composition-science`, and evaluation/accessibility roadmaps. If no completed foundation REP exists, stop and record the dependency. Separate repository claims, external evidence, and engineering judgment.
...
4. What experiment can distinguish each candidate from Goals, expectation, and learned task structure dominate bottom-up salience and Effects reverse under time pressure, peripheral viewing, or assistive technology?
