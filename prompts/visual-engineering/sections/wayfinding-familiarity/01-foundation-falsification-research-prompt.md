---
id: PRM-VE-WAY-001
title: Wayfinding, Familiarity, and Learning: Foundation and Falsification Research Prompt
...
# Wayfinding, Familiarity, and Learning: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about wayfinding, familiarity, and learning survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/wayfinding`, `../../../../content/concepts/learning`, `../../../../content/projects/composition-science/research-note/intuitive-is-just-familiar-predictive-fit-rep-v2.md`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (product-semantics, accessibility-cultural-transfer, evaluation-measurement). Distinguish repository assertions from external evidence.

## Prioritized questions

1. What proportion of intuitive performance is explained by exposure versus semantic transparency?
2. When does consistency create negative transfer?
3. How should learning curves and recoverability be measured?

## Initial and rival hypotheses

- **VE-WAY-H1:** Perceived intuitiveness is primarily predictive fit built through familiarity. Rival: Affordance, semantic transparency, feedback, and motor fluency contribute independently. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-WAY-H2:** Consistent placement and labels necessarily improve navigation. Rival: Strategic inconsistency can improve notice, learning, or safety. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
