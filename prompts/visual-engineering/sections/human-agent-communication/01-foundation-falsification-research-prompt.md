---
id: PRM-VE-HAC-001
title: Human–Agent Visual Communication: Foundation and Falsification Research Prompt
...
# Human–Agent Visual Communication: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about human–agent visual communication survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/projects/clinical-communication-engineering`, `../../../../content/projects/product-genome`, `../../../../content/projects/design-library`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (component-systems, accessibility-cultural-transfer, domain-safety). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which representations support calibrated reliance and contestability?
2. How should provenance and uncertainty remain traceable across summary layers?
3. What visual contracts reduce agent generation and interpretation errors?

## Initial and rival hypotheses

- **VE-HAC-H1:** Human-centered visual principles transfer directly to agent-facing representations. Rival: Agents need machine-readable semantics that diverge from human presentation. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-HAC-H2:** More explanation and visible uncertainty necessarily improve calibrated trust. Rival: Additional explanation can overload people or create unwarranted confidence. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
