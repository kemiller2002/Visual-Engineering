---
id: RDM-VE-HAC-001
title: Human–Agent Visual Communication Research Roadmap
...
# Human–Agent Visual Communication Research Roadmap

## A. Identity and scope

- **Identifier:** VE-HAC
- **Area and disciplines:** Human–Agent Visual Communication; human–AI interaction review, agent benchmark tasks, calibrated-trust experiments, failure-case analysis
- **Repository paths:** `content/projects/clinical-communication-engineering/`, `content/projects/product-genome/`, `content/projects/design-library/`
- **Why it exists:** Determine how interfaces communicate provenance, uncertainty, intent, control, and evidence between people and AI agents.
...
- **Adjacent sections:** component-systems, accessibility-cultural-transfer, domain-safety.
- **Taxonomy judgment:** create as distinct domain. This boundary follows mechanisms and decisions, not current folders.

## B. Current state

- **Maturity / confidence / priority:** Unframed / low / P1.
...
- **Hidden assumptions:** Human-centered visual principles transfer directly to agent-facing representations; More explanation and visible uncertainty necessarily improve calibrated trust.
...
- **Foundational:** Which representations support calibrated reliance and contestability?
- **Explanatory:** How should provenance and uncertainty remain traceable across summary layers?
- **Comparative:** What visual contracts reduce agent generation and interpretation errors?
- **Boundary-condition:** Which representations support calibrated reliance and contestability?
- **Applied engineering:** How should provenance and uncertainty remain traceable across summary layers?
- **Measurement:** What visual contracts reduce agent generation and interpretation errors?
- **Ethical/accessibility:** Which representations support calibrated reliance and contestability?
- **Cross-disciplinary:** How should provenance and uncertainty remain traceable across summary layers?

## E. Hypothesis portfolio

### VE-HAC-H1

- **Statement:** Human-centered visual principles transfer directly to agent-facing representations.
...
- **Contradiction/rivals:** Agents need machine-readable semantics that diverge from human presentation.
...
- **Method:** human–AI interaction review, agent benchmark tasks, calibrated-trust experiments, failure-case analysis.

### VE-HAC-H2

- **Statement:** More explanation and visible uncertainty necessarily improve calibrated trust.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Additional explanation can overload people or create unwarranted confidence.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-HAC-H1/H2.
- **Disciplines/sources/method:** human–AI interaction review, agent benchmark tasks, calibrated-trust experiments, failure-case analysis; primary research, reviews, standards, failures, and counterexamples.
- **Artifacts:** REP, evidence/hypothesis updates, contradiction ledger, coverage table.
- **Dependencies:** product-semantics, evaluation-measurement.
