---
id: PRM-VE-SEM-002
title: Product Semantics and Information Architecture: Engineering Translation and Validation Prompt
...
# Product Semantics and Information Architecture: Engineering Translation and Validation
...
Read `roadmap.md`, the completed foundation REP and registry updates, `../../../../content/concepts/product-design`, `../../../../content/concepts/ontology`, `../../../../content/projects/product-genome`, and evaluation/accessibility roadmaps. If no completed foundation REP exists, stop and record the dependency. Separate repository claims, external evidence, and engineering judgment.
...
4. What experiment can distinguish each candidate from Product structure is irreducibly domain- and workflow-specific and Shared schemas create false equivalence and suppress important local meaning?
