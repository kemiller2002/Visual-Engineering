---
id: PRM-VE-SEM-001
title: Product Semantics and Information Architecture: Foundation and Falsification Research Prompt
...
# Product Semantics and Information Architecture: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about product semantics and information architecture survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/product-design`, `../../../../content/concepts/ontology`, `../../../../content/projects/product-genome`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (component-systems, wayfinding-familiarity, governance-knowledge-system). Distinguish repository assertions from external evidence.

## Prioritized questions

1. What semantic units remain stable across products?
2. How should task, state, evidence, and action relationships be represented?
3. Which schema constraints reduce agent error without reducing useful variation?

## Initial and rival hypotheses

- **VE-SEM-H1:** A product genome can capture stable structures across product domains. Rival: Product structure is irreducibly domain- and workflow-specific. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-SEM-H2:** Shared semantic models improve both human understanding and agent generation. Rival: Shared schemas create false equivalence and suppress important local meaning. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
