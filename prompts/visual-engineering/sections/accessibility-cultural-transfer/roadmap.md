---
id: RDM-VE-ACC-001
title: Accessibility, Individual Difference, and Cultural Transfer Research Roadmap
...
canonical: false
concepts:
  - accessibility-cultural-transfer
---

# Accessibility, Individual Difference, and Cultural Transfer Research Roadmap

## A. Identity and scope

- **Identifier:** VE-ACC
- **Area and disciplines:** Accessibility, Individual Difference, and Cultural Transfer; coverage audit, participatory research, assistive-technology testing, cross-cultural replication
- **Repository paths:** `content/concepts/human-factors/`, `content/projects/clinical-communication-engineering/`
- **Why it exists:** Treat human variation, assistive technology, language, culture, and context as core boundary conditions.
...
- **Adjacent sections:** typography-legibility, color-contrast, human-agent-communication.
- **Taxonomy judgment:** create; prohibit edge-case treatment. This boundary follows mechanisms and decisions, not current folders.

## B. Current state

- **Maturity / confidence / priority:** Unframed / low / P0.
...
- **Hidden assumptions:** Findings from typical Western desktop users generalize sufficiently for defaults; Conformance standards are adequate proxies for accessible task performance.
...
- **Foundational:** Which current claims lack representative populations or contexts?
- **Explanatory:** Where do accessibility needs conflict with hierarchy, density, motion, or customization?
- **Comparative:** What must be redundant, adaptable, or user-controlled?
- **Boundary-condition:** Which current claims lack representative populations or contexts?
- **Applied engineering:** Where do accessibility needs conflict with hierarchy, density, motion, or customization?
- **Measurement:** What must be redundant, adaptable, or user-controlled?
- **Ethical/accessibility:** Which current claims lack representative populations or contexts?
- **Cross-disciplinary:** Where do accessibility needs conflict with hierarchy, density, motion, or customization?

## E. Hypothesis portfolio

### VE-ACC-H1

- **Statement:** Findings from typical Western desktop users generalize sufficiently for defaults.
...
- **Contradiction/rivals:** Effects vary qualitatively across disability, age, language, culture, device, and expertise.
...
- **Method:** coverage audit, participatory research, assistive-technology testing, cross-cultural replication.

### VE-ACC-H2

- **Statement:** Conformance standards are adequate proxies for accessible task performance.
- **Rationale:** This assumption is implicit in current repository framing.
- **Support:** Repository material is suggestive but not sufficient for promotion.
- **Contradiction/rivals:** Formal conformance can coexist with serious usability and comprehension failures.
- **Predicted observation:** A preregistered intervention improves a consequential task measure across specified contexts.
- **Disconfirming observation:** The effect fails, reverses, or is explained by the rival under representative conditions.
- **Boundary conditions:** population, task, expertise, language, impairment, device, environment, and time pressure.
- **Confidence / cost of error:** low-to-medium / high.
...
- **Objective:** map credible evidence and directly challenge VE-ACC-H1/H2.
- **Disciplines/sources/method:** coverage audit, participatory research, assistive-technology testing, cross-cultural replication; primary research, reviews, standards, failures, and counterexamples.
