---
id: PRM-VE-ACC-001
title: Accessibility, Individual Difference, and Cultural Transfer: Foundation and Falsification Research Prompt
abstract: Research-program artifact for the Visual Engineering repository.
created: 2026-07-23
updated: 2026-07-23
project: Visual Engineering
document_type: research-prompt
...
# Accessibility, Individual Difference, and Cultural Transfer: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about accessibility, individual difference, and cultural transfer survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/concepts/human-factors`, `../../../../content/projects/clinical-communication-engineering`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (typography-legibility, color-contrast, human-agent-communication). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which current claims lack representative populations or contexts?
2. Where do accessibility needs conflict with hierarchy, density, motion, or customization?
3. What must be redundant, adaptable, or user-controlled?

## Initial and rival hypotheses

- **VE-ACC-H1:** Findings from typical Western desktop users generalize sufficiently for defaults. Rival: Effects vary qualitatively across disability, age, language, culture, device, and expertise. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-ACC-H2:** Conformance standards are adequate proxies for accessible task performance. Rival: Formal conformance can coexist with serious usability and comprehension failures. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
