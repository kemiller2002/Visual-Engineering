---
id: PRM-VE-DOM-001
title: Domain Adaptation, Trust, and Safety: Foundation and Falsification Research Prompt
...
# Domain Adaptation, Trust, and Safety: Foundation and Falsification

## Mission

Discover whether the repository's governing claims about domain adaptation, trust, and safety survive serious evidence review and why that matters to Visual Engineering. Do not attempt to validate current theory. Treat it as provisional. Evidence overrides repository preference. Contradictions are valuable. Do not stop at a surface summary.

## Repository context

Read `../../research-roadmap.md`, `roadmap.md`, `../../../../content/projects/clinical-communication-engineering`, `../../../../content/projects/project-atlas/case-study`, the repository metadata standard, governance specification, relevant REPs, and neighboring sections (governance-knowledge-system, product-semantics). Distinguish repository assertions from external evidence.

## Prioritized questions

1. Which principles reverse under safety, legal, or time-critical constraints?
2. How should provenance, escalation, and uncertainty alter visual priorities?
3. What evidence is required before a general principle becomes a domain standard?

## Initial and rival hypotheses

- **VE-DOM-H1:** General visual-engineering principles can be adapted through parameter changes. Rival: High-stakes domains require distinct representations, workflows, and accountability. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
- **VE-DOM-H2:** Clarity, trust, and credibility tend to move together. Rival: Fluent clarity can increase dangerous overtrust and mask uncertainty. Define precisely; expose assumptions; seek support, disconfirmation, counterexamples, and boundaries; revise or reject when warranted.
