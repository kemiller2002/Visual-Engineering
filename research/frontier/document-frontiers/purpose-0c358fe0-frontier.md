...
source_status: "research-complete"
...
- Source: [content/projects/composition-science/research-report/intuitive-is-just-familiar-research-report.md](../../../content/projects/composition-science/research-report/intuitive-is-just-familiar-research-report.md)
...
- Limitations/known uncertainties: **Remaining Uncertainty:** The largest unresolved question is quantitative: how much exposure is required for familiarity to overcome specific kinds of design friction, and where does the performance curve plateau? Existing studies establish the mechanisms but do no…

## Five highest-value opportunities

| Rank | Record | Category | Frontier score |
|---:|---|---|---:|
| 1 | [RFR-A8F2407C](../records/RFR-A8F2407C.md) — Independent validation of the central claim | Validation | 493 |
| 2 | [RFR-F9BD9CF2](../records/RFR-F9BD9CF2.md) — Calibrate construct and measurement validity | Measurement | 492 |
| 3 | [RFR-FDAB353F](../records/RFR-FDAB353F.md) — Test cross-population and cross-context transfer | Accessibility | 492 |
| 4 | [RFR-CA818732](../records/RFR-CA818732.md) — Map boundary conditions and failure regimes | Experimentation | 491 |
| 5 | [RFR-7EBFD0C1](../records/RFR-7EBFD0C1.md) — Create a shared benchmark and decision threshold | Tooling | 392 |
