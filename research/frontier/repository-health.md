...
|---|---:|---|
| Accepted research artifacts analyzed | 104 | From publishable inventory after status exclusions |
| Validated/canonical/complete artifacts | 32 | Status-based proxy, not an independent quality judgment |
| Open frontier records | 520 | Five challenge lenses per accepted artifact |
| Artifacts with explicit confidence discussion | 26 | Confidence reporting coverage |
| Experiment reports | 12 | Document-type/path proxy |
| Validation coverage | 31% | Status proxy |
| Experiment coverage | 12% | Repository-wide |
| Contradiction candidates | 5 | Requires human adjudication |
...
| Average research depth | 36 sections/artifact | Structural proxy |
| Knowledge graph connectivity | 312/520 RFRs linked | Measurement dependencies |
